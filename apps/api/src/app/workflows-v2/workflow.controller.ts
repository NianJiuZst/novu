...
import {
  SdkGroupName,
  SdkMethodName,
} from "../shared/framework/swagger/sdk.decorators";
...
export class WorkflowController {
  ...
  async create(
    ...
    const upsertSteps: UpsertStepDataCommand[] = createWorkflowDto.steps.map(
      (step: StepUpsertDto) => ({
        ...step,
        controlValues:
          (step.controlValues as Record<string, unknown> | null | undefined) ??
          null,
      }),
    );
  ...
  async update(
    ...
    const upsertSteps: UpsertStepDataCommand[] = updateWorkflowDto.steps.map(
      (step: StepUpsertDto) => ({
        ...step,
        controlValues:
          (step.controlValues as Record<string, unknown> | null | undefined) ??
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves test data for a specific workflow by its unique identifier **workflowId**",
  })
