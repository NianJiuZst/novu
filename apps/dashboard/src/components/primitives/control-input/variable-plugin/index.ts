...
export function createVariableExtension({ viewRef, lastCompletionRef, onSelect, allowDelete = false }: PluginState) {
  return ViewPlugin.fromClass(
    class {
      private view: VariablePluginView;

      constructor(view: EditorView) {
        this.view = new VariablePluginView(view, viewRef, lastCompletionRef, onSelect, allowDelete);
      }
