...
>(({ className, ...props }, ref) => (
	<AlertDialogPrimitive.Action ref={ref} className={cn(buttonVariants().root(), className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
	<AlertDialogPrimitive.Cancel
		ref={ref}
		className={cn(buttonVariants({ mode: "outline", variant: "secondary" }).root(), "mt-2 sm:mt-0", className)}
		{...props}
	/>
));
