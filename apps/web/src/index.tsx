...
(async () => {
  ...
  if (LAUNCH_DARKLY_CLIENT_SIDE_ID) {
    FeatureFlagsProvider = await asyncWithLDProvider({
      ...
      options: {        // https://docs.launchdarkly.com/sdk/features/bootstrapping#:~:text=Alternatively%2C%20you%20can%20bootstrap%20feature%20flags%20from%20local%20storage%3A
