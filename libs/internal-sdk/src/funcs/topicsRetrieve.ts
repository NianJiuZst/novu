...
import {
  ...
  TopicsControllerGetTopicRequest$outboundSchema,
  TopicsControllerGetTopicResponse,
  TopicsControllerGetTopicResponse$inboundSchema,
} from "../models/operations/topicscontrollergettopic.js";
...
> {
  const input: TopicsControllerGetTopicRequest = {
    topicKey: topicKey,
  ...
  const parsed = safeParse(
    input,
    (value) => TopicsControllerGetTopicRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, TopicsControllerGetTopicResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
