...
import {
  ...
  EventsControllerCancelRequest$outboundSchema,
  EventsControllerCancelResponse,
  EventsControllerCancelResponse$inboundSchema,
} from "../models/operations/eventscontrollercancel.js";
...
> {
  const input: EventsControllerCancelRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => EventsControllerCancelRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, EventsControllerCancelResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
