...
export function subscribersCreate(
  ...
  >
> {
  return new APIPromise($do(client, createSubscriberRequestDto, idempotencyKey, options));
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.SubscribersControllerCreateSubscriberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.SubscribersControllerCreateSubscriberResponse$inboundSchema, { hdrs: true, key: 'Result' }),
