...
} from "../models/operations/subscriberscontrollercreatesubscriber.js";
...
> {
  const input: SubscribersControllerCreateSubscriberRequest = {
    createSubscriberRequestDto: createSubscriberRequestDto,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      SubscribersControllerCreateSubscriberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, SubscribersControllerCreateSubscriberResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
