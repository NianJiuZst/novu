...
> {
  const parsed = safeParse(
    request,
    (value) => operations.WorkflowControllerSearchWorkflowsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WorkflowControllerSearchWorkflowsResponse$inboundSchema, { hdrs: true, key: 'Result' }),
