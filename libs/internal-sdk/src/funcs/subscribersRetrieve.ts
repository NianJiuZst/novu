...
} from "../models/operations/subscriberscontrollergetsubscriber.js";
...
> {
  const input: SubscribersControllerGetSubscriberRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      SubscribersControllerGetSubscriberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, SubscribersControllerGetSubscriberResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
