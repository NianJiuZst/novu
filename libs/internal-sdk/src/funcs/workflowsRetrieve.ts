...
} from "../models/operations/workflowcontrollergetworkflow.js";
...
> {
  const input: WorkflowControllerGetWorkflowRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => WorkflowControllerGetWorkflowRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerGetWorkflowResponse$inboundSchema, {
      key: "Result",
    }),
