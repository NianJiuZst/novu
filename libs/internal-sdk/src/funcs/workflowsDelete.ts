...
} from "../models/operations/workflowcontrollerremoveworkflow.js";
...
export function workflowsDelete(
  ...
  Result<
    WorkflowControllerRemoveWorkflowResponse | undefined,
    | ErrorDto
    | ErrorDto
    | ValidationErrorDto
    | ErrorDto
...
> {
  const input: WorkflowControllerRemoveWorkflowRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      WorkflowControllerRemoveWorkflowRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      204,
      WorkflowControllerRemoveWorkflowResponse$inboundSchema.optional(),
    ),
