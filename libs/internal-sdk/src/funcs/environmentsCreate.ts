...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.EnvironmentsControllerV1CreateEnvironmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.EnvironmentsControllerV1CreateEnvironmentResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
