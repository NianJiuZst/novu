...
import {
  ...
  WorkflowControllerUpdateRequest$outboundSchema,
  WorkflowControllerUpdateResponse,
  WorkflowControllerUpdateResponse$inboundSchema,
} from "../models/operations/workflowcontrollerupdate.js";
...
> {
  const input: WorkflowControllerUpdateRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => WorkflowControllerUpdateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerUpdateResponse$inboundSchema, {
      key: "Result",
    }),
