...
import {
  ...
  TopicsControllerListTopicsResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => TopicsControllerListTopicsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, TopicsControllerListTopicsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
