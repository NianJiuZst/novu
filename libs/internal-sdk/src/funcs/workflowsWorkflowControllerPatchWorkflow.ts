...
} from "../models/operations/workflowcontrollerpatchworkflow.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export function workflowsWorkflowControllerPatchWorkflow(
  client: NovuCore,
  workflowId: string,
...
> {
  const input: WorkflowControllerPatchWorkflowRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      WorkflowControllerPatchWorkflowRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerPatchWorkflowResponse$inboundSchema, {
      key: "Result",
    }),
