...
import {
  ...
  EventsControllerTriggerRequest$outboundSchema,
  EventsControllerTriggerResponse,
  EventsControllerTriggerResponse$inboundSchema,
} from "../models/operations/eventscontrollertrigger.js";
...
> {
  const input: EventsControllerTriggerRequest = {
    triggerEventRequestDto: triggerEventRequestDto,
  ...
  const parsed = safeParse(
    input,
    (value) => EventsControllerTriggerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, EventsControllerTriggerResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
