...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.EnvironmentsControllerV1ListMyEnvironmentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.EnvironmentsControllerV1ListMyEnvironmentsResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
