...
} from "../models/operations/integrationscontrollergetwebhooksupportstatus.js";
 ...
 */
export function integrationsWebhooksRetrieve(
  client: NovuCore,
...
> {
  const input: IntegrationsControllerGetWebhookSupportStatusRequest = {
