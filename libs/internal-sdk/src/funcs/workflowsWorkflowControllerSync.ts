...
import {
  ...
  WorkflowControllerSyncRequest$outboundSchema,
  WorkflowControllerSyncResponse,
  WorkflowControllerSyncResponse$inboundSchema,
} from "../models/operations/workflowcontrollersync.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export function workflowsWorkflowControllerSync(
  client: NovuCore,
  workflowId: string,
...
> {
  const input: WorkflowControllerSyncRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => WorkflowControllerSyncRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerSyncResponse$inboundSchema, {
      key: "Result",
    }),
