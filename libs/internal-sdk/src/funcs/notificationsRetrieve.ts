...
} from "../models/operations/notificationscontrollergetnotification.js";
...
> {
  const input: NotificationsControllerGetNotificationRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      NotificationsControllerGetNotificationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, NotificationsControllerGetNotificationResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
