...
} from "../models/operations/workflowcontrollerpatchworkflowstepdata.js";
...
> {
  const input: WorkflowControllerPatchWorkflowStepDataRequest = {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerPatchWorkflowStepDataResponse$inboundSchema, {
      key: "Result",
    }),
