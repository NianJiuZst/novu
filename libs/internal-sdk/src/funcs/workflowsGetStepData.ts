...
} from "../models/operations/workflowcontrollergetworkflowstepdata.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export function workflowsGetStepData(
  client: NovuCore,
  workflowId: string,
  stepId: string,
...
> {
  const input: WorkflowControllerGetWorkflowStepDataRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      WorkflowControllerGetWorkflowStepDataRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerGetWorkflowStepDataResponse$inboundSchema, {
      key: "Result",
    }),
