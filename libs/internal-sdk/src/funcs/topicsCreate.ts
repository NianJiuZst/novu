...
export function topicsCreate(
  ...
  >
> {
  return new APIPromise($do(client, createUpdateTopicRequestDto, idempotencyKey, options));
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.TopicsControllerUpsertTopicRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 201], operations.TopicsControllerUpsertTopicResponse$inboundSchema, { hdrs: true, key: 'Result' }),
