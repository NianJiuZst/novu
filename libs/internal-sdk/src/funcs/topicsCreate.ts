...
} from "../models/operations/topicscontrollercreatetopic.js";
...
> {
  const input: TopicsControllerCreateTopicRequest = {
    createTopicRequestDto: createTopicRequestDto,
  ...
  const parsed = safeParse(
    input,
    (value) => TopicsControllerCreateTopicRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, TopicsControllerCreateTopicResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
