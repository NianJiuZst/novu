...
} from "../models/operations/eventscontrollerbroadcasteventtoall.js";
...
> {
  const input: EventsControllerBroadcastEventToAllRequest = {
    triggerEventToAllRequestDto: triggerEventToAllRequestDto,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      EventsControllerBroadcastEventToAllRequest$outboundSchema.parse(value),
