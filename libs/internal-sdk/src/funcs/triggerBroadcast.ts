...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.EventsControllerBroadcastEventToAllRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 201], operations.EventsControllerBroadcastEventToAllResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
    ...
    M.jsonErr([401, 403, 404, 405, 409, 413, 415], errors.ErrorDto$inboundSchema, { hdrs: true }),
