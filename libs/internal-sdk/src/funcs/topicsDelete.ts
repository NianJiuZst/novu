...
} from "../models/operations/topicscontrollerdeletetopic.js";
...
export function topicsDelete(
  ...
  Result<
    TopicsControllerDeleteTopicResponse | undefined,
    | ErrorDto
    | ErrorDto
    | ValidationErrorDto
    | ErrorDto
...
> {
  const input: TopicsControllerDeleteTopicRequest = {
    topicKey: topicKey,
  ...
  const parsed = safeParse(
    input,
    (value) => TopicsControllerDeleteTopicRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, TopicsControllerDeleteTopicResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
