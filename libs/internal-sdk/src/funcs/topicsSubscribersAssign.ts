...
import {
  ...
  TopicsControllerAssignRequest$outboundSchema,
  TopicsControllerAssignResponse,
  TopicsControllerAssignResponse$inboundSchema,
} from "../models/operations/topicscontrollerassign.js";
...
> {
  const input: TopicsControllerAssignRequest = {
    addSubscribersRequestDto: addSubscribersRequestDto,
    topicKey: topicKey,
  ...
  const parsed = safeParse(
    input,
    (value) => TopicsControllerAssignRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, TopicsControllerAssignResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
