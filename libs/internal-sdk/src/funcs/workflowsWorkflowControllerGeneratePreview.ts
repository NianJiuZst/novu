...
} from "../models/operations/workflowcontrollergeneratepreview.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export function workflowsWorkflowControllerGeneratePreview(
  client: NovuCore,
  workflowId: string,
  stepId: string,
...
> {
  const input: WorkflowControllerGeneratePreviewRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      WorkflowControllerGeneratePreviewRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, WorkflowControllerGeneratePreviewResponse$inboundSchema, {
      key: "Result",
    }),
