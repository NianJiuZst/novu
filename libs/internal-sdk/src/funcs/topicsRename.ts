...
} from "../models/operations/topicscontrollerrenametopic.js";
...
> {
  const input: TopicsControllerRenameTopicRequest = {
    renameTopicRequestDto: renameTopicRequestDto,
    topicKey: topicKey,
  ...
  const parsed = safeParse(
    input,
    (value) => TopicsControllerRenameTopicRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, TopicsControllerRenameTopicResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
