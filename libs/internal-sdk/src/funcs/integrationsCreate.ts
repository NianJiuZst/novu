...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.IntegrationsControllerCreateIntegrationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.IntegrationsControllerCreateIntegrationResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
