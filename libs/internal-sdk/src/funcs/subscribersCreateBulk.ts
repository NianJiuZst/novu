...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.SubscribersV1ControllerBulkCreateSubscribersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.SubscribersV1ControllerBulkCreateSubscribersResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
