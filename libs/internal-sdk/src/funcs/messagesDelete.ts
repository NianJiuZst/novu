...
} from "../models/operations/messagescontrollerdeletemessage.js";
...
> {
  const input: MessagesControllerDeleteMessageRequest = {
    messageId: messageId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      MessagesControllerDeleteMessageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, MessagesControllerDeleteMessageResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
