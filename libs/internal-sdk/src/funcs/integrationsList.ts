...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.IntegrationsControllerListIntegrationsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IntegrationsControllerListIntegrationsResponse$inboundSchema, { hdrs: true, key: 'Result' }),
