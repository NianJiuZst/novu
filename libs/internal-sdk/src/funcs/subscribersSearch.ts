...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SubscribersControllerSearchSubscribersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SubscribersControllerSearchSubscribersResponse$inboundSchema, { hdrs: true, key: 'Result' }),
