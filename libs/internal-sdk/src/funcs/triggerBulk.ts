...
} from "../models/operations/eventscontrollertriggerbulk.js";
...
> {
  const input: EventsControllerTriggerBulkRequest = {
    bulkTriggerEventDto: bulkTriggerEventDto,
  ...
  const parsed = safeParse(
    input,
    (value) => EventsControllerTriggerBulkRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, EventsControllerTriggerBulkResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
