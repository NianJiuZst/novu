...
} from "../models/operations/workflowcontrollersearchworkflows.js";
import { APICall, APIPromise } from "../types/async.js";
import { Result } from "../types/fp.js";

export function workflowsWorkflowControllerSearchWorkflows(
  client: NovuCore,
...
> {
  const input: WorkflowControllerSearchWorkflowsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      WorkflowControllerSearchWorkflowsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, WorkflowControllerSearchWorkflowsResponse$inboundSchema, {
      key: "Result",
    }),
