...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.IntegrationsControllerGetActiveIntegrationsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IntegrationsControllerGetActiveIntegrationsResponse$inboundSchema, {
      hdrs: true,
      key: 'Result',
    }),
