...
} from "../models/operations/subscriberscontrollerremovesubscriber.js";
...
> {
  const input: SubscribersControllerRemoveSubscriberRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      SubscribersControllerRemoveSubscriberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, SubscribersControllerRemoveSubscriberResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
