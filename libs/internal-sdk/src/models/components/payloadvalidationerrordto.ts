...
export type PayloadValidationErrorDtoValue5 =
  | string
  | number
  | boolean
  | {
...
/** @internal */
export type PayloadValidationErrorDtoValue5$Outbound = string | number | boolean | { [k: string]: any };
...
export function payloadValidationErrorDtoValue5ToJSON(
  ...
  return JSON.stringify(PayloadValidationErrorDtoValue5$outboundSchema.parse(payloadValidationErrorDtoValue5));
}
