...
import {
  ...
  type ActivityNotificationJobResponseDto$Outbound,
...
import {
  ...
  type ActivityNotificationSubscriberResponseDto$Outbound,
...
import {
  ...
  type ActivityNotificationTemplateResponseDto$Outbound,
...
import {
  ...
  type ActivityTopicDto$Outbound,
  ActivityTopicDto$outboundSchema,
} from './activitytopicdto.js';
import { type StepTypeEnum, StepTypeEnum$inboundSchema, StepTypeEnum$outboundSchema } from './steptypeenum.js';
...
export namespace ActivityNotificationResponseDtoPayload$ {
  ...
  export const inboundSchema = ActivityNotificationResponseDtoPayload$inboundSchema;
  /** @deprecated use `ActivityNotificationResponseDtoPayload$outboundSchema` instead. */
  export const outboundSchema = ActivityNotificationResponseDtoPayload$outboundSchema;
...
export function activityNotificationResponseDtoPayloadToJSON(
  activityNotificationResponseDtoPayload: ActivityNotificationResponseDtoPayload
): string {
  return JSON.stringify(
    ActivityNotificationResponseDtoPayload$outboundSchema.parse(activityNotificationResponseDtoPayload)
  );
}
...
export function activityNotificationResponseDtoPayloadFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => ActivityNotificationResponseDtoPayload$inboundSchema.parse(JSON.parse(x)),
...
/** @internal */
export const Controls$outboundSchema: z.ZodType<Controls$Outbound, z.ZodTypeDef, Controls> = z.object({});
...
export function controlsFromJSON(jsonString: string): SafeParseResult<Controls, SDKValidationError> {
  return safeParse(
    jsonString,
...
export namespace ActivityNotificationResponseDtoTo$ {
  ...
  export const outboundSchema = ActivityNotificationResponseDtoTo$outboundSchema;
...
export function activityNotificationResponseDtoToToJSON(
  ...
  return JSON.stringify(ActivityNotificationResponseDtoTo$outboundSchema.parse(activityNotificationResponseDtoTo));
}
...
> = z
  .object({
    ...
    payload: z.lazy(() => ActivityNotificationResponseDtoPayload$inboundSchema).optional(),
...
> = z
  .object({
    ...
    payload: z.lazy(() => ActivityNotificationResponseDtoPayload$outboundSchema).optional(),
    tags: z.array(z.string()).optional(),
