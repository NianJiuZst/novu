...
/** @internal */
export const ControlValues$inboundSchema: z.ZodType<ControlValues, z.ZodTypeDef, unknown> = z.union([
  InAppControlDto$inboundSchema,
  z.record(z.any()),
]);
...
/** @internal */
export const ControlValues$outboundSchema: z.ZodType<ControlValues$Outbound, z.ZodTypeDef, ControlValues> = z.union([
  InAppControlDto$outboundSchema,
  z.record(z.any()),
]);
