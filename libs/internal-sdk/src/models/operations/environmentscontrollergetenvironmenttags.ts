...
export type EnvironmentsControllerGetEnvironmentTagsResponse = {
  ...
  result: components.GetEnvironmentTagsDto;
};
...
export const EnvironmentsControllerGetEnvironmentTagsResponse$inboundSchema:
  ...
  > = z.object({
    ...
    Result: components.GetEnvironmentTagsDto$inboundSchema,
  }).transform((v) => {
    return remap$(v, {
      "Headers": "headers",
      "Result": "result",
...
export type EnvironmentsControllerGetEnvironmentTagsResponse$Outbound = {
  Headers: { [k: string]: Array<string> };
  Result: components.GetEnvironmentTagsDto$Outbound;
};
...
export const EnvironmentsControllerGetEnvironmentTagsResponse$outboundSchema:
  ...
  > = z.object({
    headers: z.record(z.array(z.string())),
    result: components.GetEnvironmentTagsDto$outboundSchema,
  }).transform((v) => {
    return remap$(v, {
      headers: "Headers",
      result: "Result",
