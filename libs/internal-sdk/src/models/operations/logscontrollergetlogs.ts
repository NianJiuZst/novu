...
export function logsControllerGetLogsRequestToJSON(logsControllerGetLogsRequest: LogsControllerGetLogsRequest): string {
  return JSON.stringify(LogsControllerGetLogsRequest$outboundSchema.parse(logsControllerGetLogsRequest));
}
...
export namespace LogsControllerGetLogsResponseBody$ {
  ...
  export const outboundSchema = LogsControllerGetLogsResponseBody$outboundSchema;
...
export function logsControllerGetLogsResponseBodyToJSON(
  ...
  return JSON.stringify(LogsControllerGetLogsResponseBody$outboundSchema.parse(logsControllerGetLogsResponseBody));
}
