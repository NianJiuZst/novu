...
export function useLayoutsUpdateMutation(
  options?: MutationHookOptions<LayoutsUpdateMutationData, Error, LayoutsUpdateMutationVariables>
): UseMutationResult<LayoutsUpdateMutationData, Error, LayoutsUpdateMutationVariables> {
