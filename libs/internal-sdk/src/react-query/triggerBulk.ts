...
export function useTriggerBulkMutation(
  options?: MutationHookOptions<TriggerBulkMutationData, Error, TriggerBulkMutationVariables>
): UseMutationResult<TriggerBulkMutationData, Error, TriggerBulkMutationVariables> {
