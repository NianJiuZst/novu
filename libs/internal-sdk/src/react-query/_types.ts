...
export type SuspenseQueryHookOptions<Data> = Omit<
  UseSuspenseQueryOptions<Data, Error>,
  'queryKey' | 'queryFn' | 'select' | keyof RequestOptions
> &
  RequestOptions;

export type InfiniteQueryHookOptions<Data extends PageIterator<unknown, unknown>> = Omit<
  UseInfiniteQueryOptions<Data, Error, InfiniteData<Data, Data['~next']>, QueryKey, Data['~next']>,
  | 'queryKey'
  | 'queryFn'
  | 'select'
  | 'getNextPageParam'
...
export type SuspenseInfiniteQueryHookOptions<Data extends PageIterator<unknown, unknown>> = Omit<
  UseSuspenseInfiniteQueryOptions<Data, Error, InfiniteData<Data, Data['~next']>, QueryKey, Data['~next']>,
  | 'queryKey'
  | 'queryFn'
  | 'select'
  | 'getNextPageParam'
