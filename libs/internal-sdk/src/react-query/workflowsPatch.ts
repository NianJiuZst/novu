...
export function useWorkflowsPatchMutation(
  options?: MutationHookOptions<WorkflowsPatchMutationData, Error, WorkflowsPatchMutationVariables>
): UseMutationResult<WorkflowsPatchMutationData, Error, WorkflowsPatchMutationVariables> {
