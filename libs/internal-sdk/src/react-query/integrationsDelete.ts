...
export function useIntegrationsDeleteMutation(
  options?: MutationHookOptions<IntegrationsDeleteMutationData, Error, IntegrationsDeleteMutationVariables>
): UseMutationResult<IntegrationsDeleteMutationData, Error, IntegrationsDeleteMutationVariables> {
