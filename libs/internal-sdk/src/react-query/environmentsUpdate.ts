...
export function useEnvironmentsUpdateMutation(
  options?: MutationHookOptions<EnvironmentsUpdateMutationData, Error, EnvironmentsUpdateMutationVariables>
): UseMutationResult<EnvironmentsUpdateMutationData, Error, EnvironmentsUpdateMutationVariables> {
