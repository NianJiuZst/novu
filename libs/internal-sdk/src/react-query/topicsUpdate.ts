...
export function useTopicsUpdateMutation(
  options?: MutationHookOptions<TopicsUpdateMutationData, Error, TopicsUpdateMutationVariables>
): UseMutationResult<TopicsUpdateMutationData, Error, TopicsUpdateMutationVariables> {
