...
export function useLayoutsGeneratePreviewMutation(
  options?: MutationHookOptions<LayoutsGeneratePreviewMutationData, Error, LayoutsGeneratePreviewMutationVariables>
): UseMutationResult<LayoutsGeneratePreviewMutationData, Error, LayoutsGeneratePreviewMutationVariables> {
