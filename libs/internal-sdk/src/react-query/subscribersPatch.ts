...
export function useSubscribersPatchMutation(
  options?: MutationHookOptions<SubscribersPatchMutationData, Error, SubscribersPatchMutationVariables>
): UseMutationResult<SubscribersPatchMutationData, Error, SubscribersPatchMutationVariables> {
