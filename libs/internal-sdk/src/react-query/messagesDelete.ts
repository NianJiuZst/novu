...
export function useMessagesDeleteMutation(
  options?: MutationHookOptions<MessagesDeleteMutationData, Error, MessagesDeleteMutationVariables>
): UseMutationResult<MessagesDeleteMutationData, Error, MessagesDeleteMutationVariables> {
