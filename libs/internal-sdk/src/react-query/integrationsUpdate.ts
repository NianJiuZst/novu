...
export function useIntegrationsUpdateMutation(
  options?: MutationHookOptions<IntegrationsUpdateMutationData, Error, IntegrationsUpdateMutationVariables>
): UseMutationResult<IntegrationsUpdateMutationData, Error, IntegrationsUpdateMutationVariables> {
