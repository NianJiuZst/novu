...
export function useSubscribersDeleteMutation(
  options?: MutationHookOptions<SubscribersDeleteMutationData, Error, SubscribersDeleteMutationVariables>
): UseMutationResult<SubscribersDeleteMutationData, Error, SubscribersDeleteMutationVariables> {
