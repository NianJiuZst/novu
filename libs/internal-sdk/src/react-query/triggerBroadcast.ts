...
export function useTriggerBroadcastMutation(
  options?: MutationHookOptions<TriggerBroadcastMutationData, Error, TriggerBroadcastMutationVariables>
): UseMutationResult<TriggerBroadcastMutationData, Error, TriggerBroadcastMutationVariables> {
