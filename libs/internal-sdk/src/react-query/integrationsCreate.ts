...
export function useIntegrationsCreateMutation(
  options?: MutationHookOptions<IntegrationsCreateMutationData, Error, IntegrationsCreateMutationVariables>
): UseMutationResult<IntegrationsCreateMutationData, Error, IntegrationsCreateMutationVariables> {
