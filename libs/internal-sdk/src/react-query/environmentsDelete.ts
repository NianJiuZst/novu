...
export function useEnvironmentsDeleteMutation(
  options?: MutationHookOptions<EnvironmentsDeleteMutationData, Error, EnvironmentsDeleteMutationVariables>
): UseMutationResult<EnvironmentsDeleteMutationData, Error, EnvironmentsDeleteMutationVariables> {
