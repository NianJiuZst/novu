...
export function useWorkflowsDeleteMutation(
  options?: MutationHookOptions<WorkflowsDeleteMutationData, Error, WorkflowsDeleteMutationVariables>
): UseMutationResult<WorkflowsDeleteMutationData, Error, WorkflowsDeleteMutationVariables> {
