...
export function useTopicsDeleteMutation(
  options?: MutationHookOptions<TopicsDeleteMutationData, Error, TopicsDeleteMutationVariables>
): UseMutationResult<TopicsDeleteMutationData, Error, TopicsDeleteMutationVariables> {
