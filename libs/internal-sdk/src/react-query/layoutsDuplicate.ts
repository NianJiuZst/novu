...
export function useLayoutsDuplicateMutation(
  options?: MutationHookOptions<LayoutsDuplicateMutationData, Error, LayoutsDuplicateMutationVariables>
): UseMutationResult<LayoutsDuplicateMutationData, Error, LayoutsDuplicateMutationVariables> {
