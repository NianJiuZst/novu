...
export function useWorkflowsDuplicateMutation(
  options?: MutationHookOptions<WorkflowsDuplicateMutationData, Error, WorkflowsDuplicateMutationVariables>
): UseMutationResult<WorkflowsDuplicateMutationData, Error, WorkflowsDuplicateMutationVariables> {
