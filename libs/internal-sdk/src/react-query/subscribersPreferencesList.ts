...
export function useSubscribersPreferencesList(
  ...
  return useQuery({
    ...buildSubscribersPreferencesListQuery(client, subscriberId, idempotencyKey, options),
    ...options,
  });
}
...
export function prefetchSubscribersPreferencesList(
  ...
  return queryClient.prefetchQuery({
    ...buildSubscribersPreferencesListQuery(client$, subscriberId, idempotencyKey),
  });
}
...
export function buildSubscribersPreferencesListQuery(
  ...
  return {
    ...
    queryFn: async function subscribersPreferencesListQueryFn(ctx): Promise<SubscribersPreferencesListQueryData> {
      ...
      return unwrapAsync(subscribersPreferencesList(client$, subscriberId, idempotencyKey, mergedOptions));
    },
  };
}
