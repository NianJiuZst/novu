...
export function useLayoutsDeleteMutation(
  options?: MutationHookOptions<LayoutsDeleteMutationData, Error, LayoutsDeleteMutationVariables>
): UseMutationResult<LayoutsDeleteMutationData, Error, LayoutsDeleteMutationVariables> {
