...
export function useEnvironmentsCreateMutation(
  options?: MutationHookOptions<EnvironmentsCreateMutationData, Error, EnvironmentsCreateMutationVariables>
): UseMutationResult<EnvironmentsCreateMutationData, Error, EnvironmentsCreateMutationVariables> {
