...
export class Layouts extends ClientSDK {
  ...
  async update(
    ...
    return unwrapAsync(layoutsUpdate(this, updateLayoutDto, layoutId, idempotencyKey, options));
  }
  ...
  async duplicate(
    ...
    return unwrapAsync(layoutsDuplicate(this, duplicateLayoutDto, layoutId, idempotencyKey, options));
  }
