...
export class Workflows extends ClientSDK {
  ...
  async update(
    ...
    return unwrapAsync(workflowsUpdate(this, updateWorkflowDto, workflowId, idempotencyKey, options));
  }
  ...
  async delete(
    ...
    return unwrapAsync(workflowsDelete(this, workflowId, idempotencyKey, options));
  }
  ...
  async patch(
    ...
    return unwrapAsync(workflowsPatch(this, patchWorkflowDto, workflowId, idempotencyKey, options));
  }
  ...
  async duplicate(
    ...
    return unwrapAsync(workflowsDuplicate(this, duplicateWorkflowDto, workflowId, idempotencyKey, options));
  }
  ...
  async sync(
    ...
    return unwrapAsync(workflowsSync(this, syncWorkflowDto, workflowId, idempotencyKey, options));
  }
}
