...
export class NovuMessages extends ClientSDK {
  ...
  async markAll(
    ...
    return unwrapAsync(
      subscribersMessagesMarkAll(this, markAllMessageAsRequestDto, subscriberId, idempotencyKey, options)
    );
  }
  ...
  async markAllAs(
    ...
    return unwrapAsync(
      subscribersMessagesMarkAllAs(this, messageMarkAsRequestDto, subscriberId, idempotencyKey, options)
    );
  }
}
