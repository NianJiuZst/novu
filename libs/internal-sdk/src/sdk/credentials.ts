...
export class Credentials extends ClientSDK {
  ...
  async update(
    ...
    return unwrapAsync(
      subscribersCredentialsUpdate(this, updateSubscriberChannelRequestDto, subscriberId, idempotencyKey, options)
    );
  }
  ...
  async append(
    ...
    return unwrapAsync(
      subscribersCredentialsAppend(this, updateSubscriberChannelRequestDto, subscriberId, idempotencyKey, options)
    );
  }
  ...
  async delete(
    ...
    idempotencyKey?: string | undefined,
    options?: RequestOptions
  ): Promise<operations.SubscribersV1ControllerDeleteSubscriberCredentialsResponse | undefined> {
    return unwrapAsync(subscribersCredentialsDelete(this, subscriberId, providerId, idempotencyKey, options));
  }
}
