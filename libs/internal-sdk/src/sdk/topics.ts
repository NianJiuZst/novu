...
export class Topics extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(topicsCreate(this, createUpdateTopicRequestDto, idempotencyKey, options));
  }
  ...
  async update(
    ...
    return unwrapAsync(topicsUpdate(this, updateTopicRequestDto, topicKey, idempotencyKey, options));
  }
