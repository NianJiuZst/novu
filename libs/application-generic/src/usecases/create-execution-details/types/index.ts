export enum DetailEnum {
  ...
  STEP_FILTERED_BY_AI_PREFERENCE = 'Step filtered by AI preference',
  STEP_PASSED_AI_PREFERENCE = 'Step passed AI preference evaluation',
  CUSTOM_EMAIL_CONTENT_GENERATED = 'Custom email content generated by AI',
  CUSTOM_NOTIFICATION_ONE_TIME_COMPLETED = 'One-time custom notification marked as completed',
