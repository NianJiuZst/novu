...
export const appearanceKeys = [
  ...
  'myNotificationsDemo',
  'myNotificationsDemoHeader',
  'myNotificationsDemoTitle',
  'myNotificationsDemoDescription',
  'myNotificationsDemoInfo',
  'myNotificationsDemoInfoTitle',
  'myNotificationsDemoInfoList',

  // My Notifications
  'myNotificationsContainer',
  'myNotificationsSection',
  'myNotificationsError',
  'myNotificationsErrorText',
  'myNotificationsLoading',
  'myNotificationsLoadingText',
  'myNotificationsHeader',
  'myNotificationsHeaderContent',
  'myNotificationsIconContainer',
  'myNotifications__sparkleIcon',
  'myNotificationsContent',
  'myNotificationsTitle',
  'myNotificationsLabel',
  'myNotificationsBadge',
  'myNotificationsDescription',
  'myNotificationsAddButton',
  'myNotificationsForm',
  'myNotificationsFormHeader',
  'myNotificationsFormTitle',
  'myNotificationsFormDescription',
  'myNotificationsFormField',
  'myNotificationsFormLabel',
  'myNotificationsFormTextarea',
  'myNotificationsFormMeta',
  'myNotificationsFormHint',
  'myNotificationsFormCounter',
  'myNotificationsFormActions',
  'myNotificationsFormSubmit',
  'myNotificationsFormCancel',
  'myNotificationsFormCheckbox',
  'myNotificationsFormCheckboxInput',
  'myNotificationsFormCheckboxLabel',
  'myNotificationsFormCheckboxHint',
  'myNotificationsList',
  'myNotificationsListTitle',
  'myNotificationsListItem',
  'myNotificationsListItemContent',
  'myNotificationsListItemText',
  'myNotificationsListItemHeader',
  'myNotificationsListItemQuery',
  'myNotificationsListItemContent',
  'myNotificationsListItemDate',
  'myNotificationsListItemActions',
  'myNotificationsListItemToggle',
  'myNotificationsListItemStatus',
  'myNotificationsListItemRemove',
  'myNotificationsOneTimeBadge',
  'myNotificationsEmpty',
  'myNotificationsEmptyText',
  'myNotifications__arrowIcon',
  ...
  'notifyModal',
  'notifyModalHeader',
  'notifyModalHeaderContent',
  'notifyModalIcon',
  'notifyModalSparkle',
  'notifyModalTitleContainer',
  'notifyModalTitle',
  'notifyModalDescription',
  'notifyModalClose',
  'notifySuccess',
  'notifySuccessIcon',
  'checkIcon',
  ...
  'notifyFormCounter',
  'notifyFormCheckbox',
  'notifyFormCheckboxInput',
  'notifyFormCheckboxLabel',
  'notifyFormCheckboxHint',
  'notifyFormActions',
  'notifyFormCancel',
  'notifyFormSubmit',
  'submitIcon',
