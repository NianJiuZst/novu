...
export const defaultInboxLocalization = {
  ...
  'aiChats.title': 'AI chats',
  'aiChats.empty': 'No agent conversations yet.',
  'aiChats.via': 'via',
  'aiChats.messages': 'messages',
  'aiChats.message': 'message',
  'aiChats.conversationNoMessagesYet': 'No messages yet.',
  'aiChats.threadEmpty': 'No messages in this thread.',
